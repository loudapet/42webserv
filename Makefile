...
#    Updated: 2024/07/08 16:35:07 by okraus           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
cgi: ./test_cgi-bin/test_cgi1.cpp
	@echo "$(CYAN)Compiling cgi...$(RESET)"
	$(COMP) ./test_cgi-bin/test_cgi1.cpp -o ./test_cgi-bin/test1.cgi
